        ...
        <el-form ref="form" :model="form" label-width="80px">
          <el-collapse v-model="activeNames" @change="handleChange">
            <el-collapse-item title="项目信息" name="1">
              <el-row>
                <el-col :span="8">
                  <el-form-item label="项目编号："><el-input v-model="form.name"></el-input></el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="项目类别：">
                    <el-select v-model="form.region" placeholder="请选择项目类别">
                      ...
                      <el-option label="房屋建设" value="2"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="10">
                  <el-form-item label="招标人："><el-input v-model="form.name"></el-input></el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item label="招标地址："><el-input v-model="form.name"></el-input></el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="5">
                  <el-form-item label="邮政编码："><el-input v-model="form.name"></el-input></el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item label="联系人："><el-input v-model="form.name"></el-input></el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item label="联系电话："><el-input v-model="form.name"></el-input></el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item label="传真："><el-input v-model="form.name"></el-input></el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item label="招标时间："><el-date-picker v-model="form.startTime" type="datetime" placeholder="选择日期时间" default-time="12:00:00"></el-date-picker></el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="项目状态：">
                    <el-select v-model="form.region" placeholder="请选择项目状态">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="公开参考价：">
                    <el-select v-model="form.region" placeholder="请选择是否公开参考价">
                ...
                <el-col :span="8">
                  <el-form-item label="最少竞争数：">
                    <el-select v-model="form.region1" placeholder="请选择至少参与供应商">
                ...
                <el-col :span="8">
                  <el-form-item label="中标方式：">
                    <el-select v-model="form.region2" placeholder="请选择中标方式">
                      <el-option label="价低者得" value="shanghai"></el-option>
                      <el-option label="价高者得" value="beijing"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              </el-row>
